...
import ProductOverviewShimmer from './ProductOverviewShimmer';
      ...
      <div className="mx-auto max-w-5xl px-5 py-24">
        <div className="mx-auto flex flex-wrap items-center lg:w-4/5">
          ...
          <div className="mt-6 w-full lg:mt-0 lg:w-1/2 lg:pl-10 flex flex-col">
            <h2 className="text-sm font-semibold tracking-widest text-gray-500">{productInfo.category.name}</h2>
            <h1 className="my-4 text-3xl font-semibold text-black">{productInfo.title}</h1>
            ...
            <span className="title-font text-xl font-bold text-gray-900">₹{productInfo.price}</span>
              <button
                type="button"
